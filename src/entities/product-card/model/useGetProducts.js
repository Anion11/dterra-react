...
export const useGetProducts = () => {
    ...
    const getProducts = async () => {
        try {
            ...
            const filterDataEven = data.filter((item, index) => index % 2 === 0); /* берем каждый второй */
            const filterData = filterDataEven.map((item, index) => index % 3 === 0 ? { ...item, title: undefined } : item); /* у каждого 3 из оставшихся у нас title = undefined */
